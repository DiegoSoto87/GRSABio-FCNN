...
partem_s.o esolan.o opesol.o annealident.o metropolisbio.o\
bioinspired.o
...
opeflx.f opeshe.f minim.f minqsn.f contacts.f hbond.f helix.f anneal.f90  rgyr.f \
...
mulcan_par_mod.f90 esolan.f opesol.f annealident.f\
metropolisbio.f bioinspired.f
# partem_s.f
...
init_energy.o init_molecule.o gradient.o energy.o nursvr.o regul.o\
eninteract.o bgs.o eyabgn.o enylun.o annealident.o metropolis02.o\
metropolis03.o metropolisbio.o bioinspired.o\
